...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    h_out, h_cache = affine_relu_forward(conv_out, W2, b2)
    scores, sc_cache = affine_forward(h_out, W3, b3)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    dl_dh, grads['W3'], grads['b3'] = affine_backward(dl_ds, sc_cache)
    dl_dconv, grads['W2'], grads['b2'] = affine_relu_backward(dl_dh, h_cache)
    dx, grads['W1'], grads['b1'] = conv_relu_pool_backward(dl_dconv, conv_cache)
